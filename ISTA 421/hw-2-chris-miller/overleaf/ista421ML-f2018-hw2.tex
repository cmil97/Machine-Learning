...
The best 1st-order polynomial model =

\begin{eqnarray*}
f(x;\mathbf{w}) = \mathbf{w}\top\mathbf{x} = 
\begin{bmatrix}
    w_0 & w_1
\end{bmatrix}
\begin{bmatrix}
...
\caption{\label{fig:linearModelWomen}best 1st-order polynomial model for the women's 100m data.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{LOOCV.png}
\caption{\label{fig:4.3}Train loss and CV loss for leave one out cross-validation.}
\end{figure}
...
Step 1: Convert loss into matrix form, assume:
